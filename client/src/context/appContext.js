...
const AppProvider = ({ children }) => {
    ...
    const registerUser = async (currentUser) => {
        ...
        try {
            const response = await axios.post(`${SERVER_URL + USER_API_URL}register`, currentUser)
    ...
    const loginUser = async (currentUser) => {
        ...
        try {
            const response = await axios.post(`${SERVER_URL + USER_API_URL}login`, currentUser)
            console.log(response)
            const { user, token, location } = response.data
            addUserToLocalStorage({ user, token, location })
    ...
    const updateUser = async (currentUser) => {
        ...
        try {
            const response = await axios.patch(`${SERVER_URL + USER_API_URL}updateuser`, currentUser, AUTH_HEADER)
